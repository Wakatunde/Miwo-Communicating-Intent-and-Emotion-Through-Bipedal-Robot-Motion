...
Body pose commands are expressed in the robots base frame and operate as a 6-DOF cartesian pose with position [x,y,z] expressed in millimeters and orientation [roll, pitch, yaw] in degrees. The body pose controller transforms these commands into per-leg foot position targets expressed relative to each hip joint center. This transformation has to account for several geometric 
